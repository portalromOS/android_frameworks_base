...
public final class PowerManagerService extends SystemService
    ...
    PowerManagerService(Context context, Injector injector) {
        ...
        mButtonBrightnessDefault = mContext.getResources().getFloat(
                org.portalrom.platform.internal.R.dimen
    ...
    public void systemReady(IAppOpsService appOps) {
        ...
        resolver.registerContentObserver(PortalRomSettings.Secure.getUriFor(
                ...
                false, mSettingsObserver, UserHandle.USER_ALL);
        resolver.registerContentObserver(PortalRomSettings.System.getUriFor(
                PortalRomSettings.System.BUTTON_BACKLIGHT_ONLY_WHEN_PRESSED),
                false, mSettingsObserver, UserHandle.USER_ALL);
        resolver.registerContentObserver(PortalRomSettings.Secure.getUriFor(
    ...
    void readConfigurationLocked() {
        ...
        mProximityWakeEnabledByDefaultConfig = resources.getBoolean(
                org.portalrom.platform.internal.R.bool.config_proximityCheckOnWakeEnabledByDefault);
        mProximityTimeOut = resources.getInteger(
                org.portalrom.platform.internal.R.integer.config_proximityCheckTimeout);
    ...
    private void updateSettingsLocked() {
        ...
        mWakeUpWhenPluggedOrUnpluggedSetting = PortalRomSettings.Global.getInt(resolver,
                PortalRomSettings.Global.WAKE_WHEN_PLUGGED_OR_UNPLUGGED,
        ...
        mProximityWakeEnabled = PortalRomSettings.System.getInt(resolver,
                PortalRomSettings.System.PROXIMITY_ON_WAKE,
        ...
        mButtonTimeout = PortalRomSettings.Secure.getIntForUser(resolver,
                PortalRomSettings.Secure.BUTTON_BACKLIGHT_TIMEOUT,
                DEFAULT_BUTTON_ON_DURATION, UserHandle.USER_CURRENT);
        mButtonBrightness = PortalRomSettings.Secure.getFloatForUser(resolver,
                PortalRomSettings.Secure.BUTTON_BRIGHTNESS, mButtonBrightnessDefault,
                UserHandle.USER_CURRENT);
        mButtonLightOnKeypressOnly = PortalRomSettings.System.getIntForUser(resolver,
                PortalRomSettings.System.BUTTON_BACKLIGHT_ONLY_WHEN_PRESSED,
                0, UserHandle.USER_CURRENT) == 1;
        mKeyboardBrightness = PortalRomSettings.Secure.getFloatForUser(resolver,
                PortalRomSettings.Secure.KEYBOARD_BRIGHTNESS, mKeyboardBrightnessDefault,
                UserHandle.USER_CURRENT);
