...
public final class AssetManager implements AutoCloseable {
    ...
    private static final String PORTALROM_APK_PATH = "/system/framework/org.portalrom.platform-res.apk";
    ...
    public static void createSystemAssetsInZygoteLocked(boolean reinitialize,
        ...
        try {
            ...
            apkAssets.add(ApkAssets.loadFromPath(PORTALROM_APK_PATH, ApkAssets.PROPERTY_SYSTEM));
